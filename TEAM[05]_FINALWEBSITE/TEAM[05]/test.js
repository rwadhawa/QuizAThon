...
function setQuestions () {
  for (let i = 0; i < 10; i++) {
    ...
    let qs = '';
    for (let j = 0; j < 4; j++) {
      qs = `${qs}<input type='radio' name='${i + 1}' value='${optionoption[j].toLowerCase ()}' id='radio${optionoption[j]}q${i + 1}'><label for='radio${optionoption[j]}q${i + 1}'>${optionoption[j].toLowerCase ()}) ${options[4 * i + j]}</label><br>`;
    }
...
function setMathtest () {
  ...
  options = [
    '4x - 10','2x - 5','4x - 5','4x - 5 + 1','xe^x','e^x','xe^(x-1)','e^(x-1)','2x^5 - 3x^6 - 1','2x^5 - 9x^2','12x^5 - 9x^2','12x^5 - 9x^2 - 1','14x - 9',
    '7x - 18','14x^2 - 9x','7x - 9','x^2 - 4x','3x^2 - 4x','3x^2','x^2 - 4x - 1','4x^4 - 2x','20x^5 - 4x^2 - 6','4x^4 - 4x - 1','20x^4 - 4x','6x^6 - 9x','42x^6 - 18x + 2',
    '42x^6 - 18x','6x^6 - 18x + 2','4x + 5','8x + 5','8x^2 + 5x + 7','4x + 1','8x - 6','16x - 6 + 1','16x - 6','8x - 6 + 1','12x^2 - 14x + 9','3x^3 - 7x','12x^3 - 14x','12x^3 - 7x'];
...
function setEnglishtest () {
  ...
  options = [
    'They were cocky.','They were respectful.','They were ready to kill him.','They were neutral to him.','Amicable','Beneficial','Theoretical','Practical','Intention','Consequences',
    'Act itself','All of the above','Zhi','Yi','Ren','Li','Prejudice','Hostility','Cruelty','Hatred','The Copper Example','The Wax Example','The Water Example','The Rubber Example',
    'She says Creon is a bad king.','She wants to lead a rebellion.','She wants to escape the country.','She wants a ritual lauding deaths','Studying humanity&#39s nature.','Being humane to others.',
    'Benevolence towards all.','Liberalism/Secularistic Beliefs.','Golden Age','Silver Age','Bronze Age','Iron Age','An honorable man.','A benevolent man.','A wealthy man.','A trickster.'];
  document.getElementById ('logo').src =
...
function setSciencetest () {
  ...
  options = [
    'Nucleus','Cell Membrane','Mitochondria','Cytoplasm','100,000,000,000','6 × 10^24','10 lb','5 x 10^27','Deoxyribonucleic Acid','Dextro Nucleic Acid','Deoxynormic Acid','Danimals Acid',
    '157','206','183','214','Carbon','Nitrogen','Oxygen','Phosphorus','100 degrees','0 degrees','273 degrees','-40 degrees','Reflection','Light bending','Refraction','Transfraction',
    '5','7','10','3','Mercury','Helium','Manganese','Venus','57%','69%','77%','71%'];
  document.getElementById ('logo').src =
...
function setHistorytest () {
  ...
  options = [
    'Elon Musk','Christopher Columbus','Neil Armstrong','William Clark','The US Constitution','The US Declaration of Independence','The Treaty of Paris','The Bill of Rights','New York City',
    'Albany','Boston','Philadelphia','John Adams','Abraham Lincoln','George Washington','John Hansen','Thomas Edison','Benjamin Franklin','Nicholas Tesla','Elon Musk','18th','12th',
    '7th','19th','Italy','Britain','Haiti','France','Donald Trump','Abraham Lincoln','Andrew Jackson','Richard Nixon','Three','Four','Two','One','Henry Ford','John Chevrolet','John Stewart','George Matthew Chrysler'];
  document.getElementById ('logo').src =
